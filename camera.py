...
class VideoCamera(object):
    ...
    def get_frame(self):
        ...
        while True:
            ...
            plates = plates_cascade.detectMultiScale(image, 1.5, 5)
            ...
            for (x,y,w,h) in plates:
                ...
                data = pytesseract.image_to_string(color_image, config='-l eng --oem 1 --psm 6 tessedit_char_whitelist =ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789')
                # print(data)
